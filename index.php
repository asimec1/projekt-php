<?php 
	...
	if(!isset($_GET['wysiwyg'])) { $_GET['wysiwyg'] = false; }
...
<html>
	...
	if ($menu==7) { print '<script src="https://cdn.tiny.cloud/1/61pzj0cbo7b26hsvc7ndn95po9c8hwbycade5oen33055ztc/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>'; }
	print '
	</head>
<body>
	<header>
	...
	# API products
	else if ($menu == 12) { include("products.php"); }

	# Gallery
	else if ($menu == 20) { include("gallery.php"); }
